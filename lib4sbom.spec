...
Source0  : https://github.com/anthonyharrison/lib4sbom/archive/v0.7.3/lib4sbom-0.7.3.tar.gz
...
%prep
%setup -q -n lib4sbom-0.7.3
cd %{_builddir}/lib4sbom-0.7.3
pushd ..
cp -a lib4sbom-0.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724079832
...
cp %{_builddir}/lib4sbom-%{version}/lib4sbom/license.py %{buildroot}/usr/share/package-licenses/lib4sbom/6d68a831cb8034cd6cee59a888c3fef24fe8eafc || :
...
/usr/share/package-licenses/lib4sbom/6d68a831cb8034cd6cee59a888c3fef24fe8eafc
