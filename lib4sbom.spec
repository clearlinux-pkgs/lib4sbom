...
Version  : 0.8.5
Release  : 28
URL      : https://github.com/anthonyharrison/lib4sbom/archive/v0.8.5/lib4sbom-0.8.5.tar.gz
Source0  : https://github.com/anthonyharrison/lib4sbom/archive/v0.8.5/lib4sbom-0.8.5.tar.gz
...
%prep
%setup -q -n lib4sbom-0.8.5
cd %{_builddir}/lib4sbom-0.8.5
pushd ..
cp -a lib4sbom-0.8.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750862987
