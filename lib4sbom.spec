...
Source0  : https://github.com/anthonyharrison/lib4sbom/archive/v0.8.0/lib4sbom-0.8.0.tar.gz
...
%prep
%setup -q -n lib4sbom-0.8.0
cd %{_builddir}/lib4sbom-0.8.0
pushd ..
cp -a lib4sbom-0.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733819075
