...
Version  : 0.8.4
Release  : 27
URL      : https://github.com/anthonyharrison/lib4sbom/archive/v0.8.4/lib4sbom-0.8.4.tar.gz
Source0  : https://github.com/anthonyharrison/lib4sbom/archive/v0.8.4/lib4sbom-0.8.4.tar.gz
...
%prep
%setup -q -n lib4sbom-0.8.4
cd %{_builddir}/lib4sbom-0.8.4
pushd ..
cp -a lib4sbom-0.8.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745274306
