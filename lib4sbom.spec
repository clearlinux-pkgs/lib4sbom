...
Version  : 0.7.0
Release  : 16
URL      : https://github.com/anthonyharrison/lib4sbom/archive/v0.7.0/lib4sbom-0.7.0.tar.gz
Source0  : https://github.com/anthonyharrison/lib4sbom/archive/v0.7.0/lib4sbom-0.7.0.tar.gz
...
%prep
%setup -q -n lib4sbom-0.7.0
cd %{_builddir}/lib4sbom-0.7.0
pushd ..
cp -a lib4sbom-0.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711404584
