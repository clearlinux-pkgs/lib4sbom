...
Version  : 0.7.2
Release  : 18
URL      : https://github.com/anthonyharrison/lib4sbom/archive/v0.7.2/lib4sbom-0.7.2.tar.gz
Source0  : https://github.com/anthonyharrison/lib4sbom/archive/v0.7.2/lib4sbom-0.7.2.tar.gz
...
%prep
%setup -q -n lib4sbom-0.7.2
cd %{_builddir}/lib4sbom-0.7.2
pushd ..
cp -a lib4sbom-0.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722265880
