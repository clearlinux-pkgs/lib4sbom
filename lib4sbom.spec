...
Source0  : https://github.com/anthonyharrison/lib4sbom/archive/v0.5.4/lib4sbom-0.5.4.tar.gz
...
%prep
%setup -q -n lib4sbom-0.5.4
cd %{_builddir}/lib4sbom-0.5.4
pushd ..
cp -a lib4sbom-0.5.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702493856
