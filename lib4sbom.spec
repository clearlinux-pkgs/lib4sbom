...
Source0  : https://github.com/anthonyharrison/lib4sbom/archive/v0.8.2/lib4sbom-0.8.2.tar.gz
...
%prep
%setup -q -n lib4sbom-0.8.2
cd %{_builddir}/lib4sbom-0.8.2
pushd ..
cp -a lib4sbom-0.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741109393
