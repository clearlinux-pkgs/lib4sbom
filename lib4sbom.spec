...
Version  : 0.8.3
Release  : 26
URL      : https://github.com/anthonyharrison/lib4sbom/archive/v0.8.3/lib4sbom-0.8.3.tar.gz
Source0  : https://github.com/anthonyharrison/lib4sbom/archive/v0.8.3/lib4sbom-0.8.3.tar.gz
...
%prep
%setup -q -n lib4sbom-0.8.3
cd %{_builddir}/lib4sbom-0.8.3
pushd ..
cp -a lib4sbom-0.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744671192
